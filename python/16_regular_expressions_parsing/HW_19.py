...
for device in devices:
    if isinstance(device, dict):
        ...
        lab_env = lab_envs.get(device_name, None)
        device['lab_env'] = lab_env

# Write combined data to devises_vs_lab_env.yaml
with open('devises_vs_lab_env.yaml', 'w') as devises_vs_lab_env:
    yaml.safe_dump(devices, devises_vs_lab_env)
