...
from studens_class import Student
...
def student_create():
    ...
    return (f"Added student (name={student.name},"
...
def update_student(student_id):
    ...
    return f"Student id [{student_id}] is absent"
...
def delete_student(student_id):
    ...
    for student in students:
        if student.student_id == student_id:
            ...
            return (f"Deleted student (name={student.name},"
                    f"id={student.student_id})")
    return f"Student id [{student_id}] is absent"
