def operation_with_file(operation: str, file_path: str, content=None):
    """
    ...
    if operation not in operations_list:
        raise ValueError(
            f"Invalid argument '{operation}'. Please choose some from {operations_list}"
        )
...
print(operation_with_file("w", "homework.txt", "Hello World?"))
